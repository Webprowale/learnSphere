...
class CourseController extends BaseController
{
    ...
    public function create_course()
    {
        ...
        if ($this->validator->run()) {
            ...
            $db->insert($data);
            return view('create_course', ['message' => 'Course created successfully']);
        } else {
            return view('create_course', ['errors' => $this->validator->getErrors()]);
        }
    }
    ...
    public function get_course($id){
        $db = new CourseModel();
        $course = $db->find($id);
        return view('get_course_details',$course);
    }
...
public function create_lesson()
{
    ...
    $this->validate([
        ...
        'video' => 'permit_empty|uploaded[video]|max_size[video,307200]|ext_in[video,mp4,avi,mov]',
        'quiz_id' => 'permit_empty|integer',
    ...
    if ($this->validator->run()) {
        ...
        $db->insert($data);
        return view('create_lesson', ['message' => 'Lesson created successfully']);
    } else {
        return view('create_lesson', ['errors' => $this->validator->getErrors()]);
    }
}
