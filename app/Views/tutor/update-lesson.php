...
<!-- Page Heading -->
<div class="mb-4">
    <h4 class="fw-bold">Update Lessson</h4>
</div>
...
<div class="container my-3 shadow rounded px-md-5 px-2 py-4 bg-white mt-5">
    ...
    <?php endif; ?>
    <form method="post" action="<?=base_url('control/lesson-update/'.esc($lesson['id'])) ?>" enctype="multipart/form-data">
        <div class="row">
        <div class="mb-3  rounded col-md-6">
            <label for="title" style="background-color: transparent;">Title</label>
            <input type="text" name="title" value="<?= esc($lesson['title']); ?>" class="form-control text-black" placeholder="Title...">
        ...
        <input type="submit" name="register" value="Update" class=" col-md-2 mt-3 btn btn-primary text-white form-control b fs-5">
        </div>
    </form>
