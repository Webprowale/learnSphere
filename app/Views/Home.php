                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8 ">
                                ...
                                <a href="#learnmore" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Read More</a>
                                <a href="<?= base_url('register') ?>" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" id="learnmore">
                    ...
                    <a class="btn btn-primary py-3 px-5 mt-2" href="<?=base_url('about') ?>">Read More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                ...
                <div class="testimonial-item text-center">
                    ...
                    <div class="testimonial-text bg-light text-center p-4">
                    <p class="mb-0">"As a software engineer, I wanted to expand my skill set, and LearnSphere’s data science courses were top-notch. Highly recommended!</p>
                    </div>
                </div>
                <div class="testimonial-item text-center">
